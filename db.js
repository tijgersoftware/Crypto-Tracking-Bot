...
export async function insertData(data){
  ...
  try {
    await db('alerts').insert({ pair:data.pair ,timestamp: data.timestamp, initial_value: data.initial_value, rate:data.rate, fetchInterval:data.fetchInterval, database: data.database, oscillation: data.oscillation, refresh:data.refresh, updateAllPairs:data.updateAllPairs, pairsFile:data.pairsFile})
